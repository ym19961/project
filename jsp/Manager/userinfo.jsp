...
$(document).ready(function(){
	...
	$("#updatename").click(function(){
		...
		$.post("updateUserName",{userid:userid,username:username},function(data){
				location.reload();
		});
	});
	$("#updatepassword").click(function(){
		...
		if(newpassword!=repassword){
			...
			$("#pwd-errinfo1").hide();
			$.post("updatepassword",{password:newpassword,userid:userid},function(data){
				location.reload();
